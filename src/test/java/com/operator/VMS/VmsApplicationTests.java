...
//mock repository 
	 ...
	 */
	@Test
	public void getVisitorsTest() throws JsonProcessingException {
		when(visitorRepository.findAll()).thenReturn(Stream.of(new Visitor(1, "Anushree", "anu@gmail.com", 0, "9845671230", "Deola", "India", "Maharastra", "Pune", "adhar card", "Ekta", "ekta@gmail.com", "naukari",
				"interview", 0)).collect(Collectors.toList()));
